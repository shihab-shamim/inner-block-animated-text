 ...
 *
 * The bars carry three different brand colours on purpose: each one is a separately
 * configured element, so the colour says something true about the block rather than just
 * decorating it. The orange caret is the single contrast accent. The frame stays on
 * currentColor so it still adapts to the light and dark admin schemes.
 *
...
export const blockIcon = <svg xmlns='http://www.w3.org/2000/svg' width={24} height={24} viewBox='0 0 24 24' fill='none' aria-hidden='true' focusable='false'>
	<style>{`
		...
		@keyframes ibtaIcoBlink { 0%, 49% { opacity: 1; } 50%, 100% { opacity: .2; } }
		@media (prefers-reduced-motion: reduce) {
			.ibtaIcoBar, .ibtaIcoCaret { animation: none; opacity: 1; translate: none; }
		}
	`}</style>

	<rect x='2.7' y='3.7' width='18.6' height='16.6' rx='3.4' stroke='currentColor' strokeWidth='1.6' opacity='.3' />

	<rect className='ibtaIcoBar ibtaIcoBar1' x='6' y='7.55' width='12' height='2.1' rx='1.05' fill='#7C5CFF' />
	<rect className='ibtaIcoBar ibtaIcoBar2' x='6' y='11.35' width='9' height='2.1' rx='1.05' fill='#146EF5' />
	<rect className='ibtaIcoBar ibtaIcoBar3' x='6' y='15.15' width='5.4' height='2.1' rx='1.05' fill='#0E9CB8' />

	<rect className='ibtaIcoCaret' x='12.7' y='14.5' width='1.5' height='3.4' rx='.75' fill='#E56100' />
</svg>;
